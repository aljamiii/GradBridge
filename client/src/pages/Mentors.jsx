...
function MentorCard({ mentor }) {
  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
      ...
      {mentor.availability && (
        <p className="mt-2 text-sm text-slate-500">🕒 {mentor.availability}</p>
      )}
...
export default function Mentors() {
  ...
  return (
    <div className="mx-auto w-full max-w-3xl flex-1 px-4 py-10">
      <h1 className="text-2xl font-bold text-slate-800">🧭 Find a Mentor</h1>
      ...
      <div className="mt-6 space-y-4">
        {mentors === null ? (
          <p className="py-10 text-center text-slate-400">Loading mentors…</p>
        ) : mentors.length === 0 ? (
